import Currencyimg from '../assets/currency/currency.png'
const Currency = () =>{
    return (
        <>
            <div className=" mx-4 flex flex-col text-gray-700 ">
                ...
                <div className="my-10 rounded-lg bg-gray-200 p-8">
                    <div class=" flex flex-row  gap-y-4 mb-8 text-lg" >
                        ...
                        <p className='text-orange-500 ml-2'> Currency <a class="font-semibold">(4 puntos)</a></p>
                    </div>
                    <p class="text-gray-600 text-3xl font-bold mb-6">Currency basics</p>
                    <img src={Currencyimg} class=" w-full"  alt="" />
                    </div>
            </div>
        </>
    )
