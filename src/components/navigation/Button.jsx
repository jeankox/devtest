...
export default function MenuButton()
{
    ...
    const Categories= [{logo:a1, name:"Geography", link:"/geography"}, {logo:a2, name:"Holidays", link:"/holidays"},
                      {logo:a3, name:"Sports", link:"/sports"},   {logo:a4, name:"Cuisine", link:"/cuisine"}, 
                      {logo:a5, name:"Language", link:"/languaje"}, {logo:a6, name: "Currency", link:"/currency"}]
    ...
    return(
      <div>
        <button onClick={() => setShowMore(!showMore)} 
          ...
          {showMore ? 
            <Link to="/">
              <div class="flex justify-between items-center px-4 py-3"><p>Culture specifics</p><img class="w-6 h-3" src={v2}/> </div> 
            </Link>: 
            <div class="flex justify-between px-4 py-3 items-center"><p>Culture specifics</p><img class=" w-3 h-6" src={v1}/></div>}
        </button>
        {showMore && (
